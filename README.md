...
### Admin
_Tools that extend and enhance Django's built-in admin interface for better usability, productivity, and team collaboration._

#### User Impersonation

_Allow admins and staff to sign in as other users for support, debugging, and account inspection._
...
_Tools for importing, exporting, paginating, and presenting data more cleanly in Django admin._
...
_Packages that improve admin safety, team collaboration, and day-to-day operational tasks._
...
_Drop-in themes and skins that replace Django's default admin UI with more polished, modern, or branded interfaces._
...
### APIs
_Packages for building, securing, documenting, and extending REST and GraphQL APIs in Django._

#### REST Frameworks

_Core frameworks for building REST APIs on top of Django._
...
_Token, session, and JWT-based authentication packages for Django REST APIs._
...
_Libraries for building GraphQL APIs with Django using schema-first or type-driven approaches._
...
_Tools for generating OpenAPI and Swagger schemas and API documentation from DRF._
...
_Cross-cutting API concerns like CORS, asset bridging, and outgoing webhook delivery._
...
_Django extensions for asynchronous patterns, real-time communication, and event-driven architecture._
...
_Tools to cache ORM queries and reduce database load in Django applications._
...
### Commands
_Packages for writing, extending, and managing Django management commands and CLI tooling._

#### CLI Authoring

_Tools for writing richer, more ergonomic Django management commands using Click or Typer._
...
_Management commands for database backups, migration state, and schema maintenance._
...
### Configuration
_Tools for managing Django settings, environment variables, secrets, and runtime configuration._

#### Environment & Secrets

_Load and validate settings from `.env` files, environment variables, and secret stores._
...
_Organize and validate how Django settings files are written, split, and inherited._
...
_Store settings in the database or cache and edit them through Django admin without redeploying._
...
_Full-featured CMS platforms and frameworks built on top of Django._
...
_Libraries for introducing dependency injection patterns into Django for more modular, testable code._
...
_Complete e-commerce platforms and frameworks built with Django._
...
### Editors
_Packages that embed text, rich content, and code editors into Django forms and admin._

#### Rich Text & WYSIWYG

_Embed WYSIWYG editors into Django forms and admin for formatted content authoring._
...
_Markdown-based editing with preview and upload support for lightweight content workflows._
...
_Embed code editors and visual logic builders directly in Django applications._
...
_Tools for managing file uploads, image processing, and thumbnail generation in Django._
...
_Packages that improve Django form rendering, multi-step workflows, and widget customization._
...
_Frameworks for building reactive, real-time, or component-driven UIs on top of Django._

#### Server-Driven UI

_LiveView-style patterns for building reactive interfaces without leaving Django templates._
...
_Connect Django to React frontends or build Python-driven component UIs._
...
### General
_Broadly useful utilities for data browsing, querying, site management, and general Django development._

#### Data Browsing & Querying

_Tools for filtering, browsing, querying, and presenting model data in Django._
...
_Packages for maintenance mode, static site export, content sanitization, and site-level tooling._
...
_Higher-level frameworks and tools that improve developer productivity and code quality in Django projects._
...
_Packages for translating Django models, forms, and UI across multiple languages and locales._
